...
Tener XAMPP instalado (versión 7.4 o superior).
👉 Descargar XAMPP
...
Cuando termine, deberías ver todas las tablas creadas correctamente (Usuarios, Paseadores, Mascotas, etc.).🐾 Guía para ejecutar el proyecto HelPet
🔧 Requisitos previos
...
Después del registro, te redirigirá automáticamente al dashboard correspondiente según el tipo de usuario.🌐 4. Ejecutar el sistema
